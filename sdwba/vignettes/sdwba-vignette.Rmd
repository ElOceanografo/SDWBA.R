...
freq.spec.cont <- frequency.spectrum(krill, 12e3, 400e3, sound.speed.water, nfreq=120,
                                     method="continuous")
plot(freq.spec$freq, freq.spec$TS, ty='l')
lines(freq.spec.cont$freq, freq.spec.cont$TS, col='blue')

tilt.spec <- tilt.spectrum(krill, -180, 180, freq=120e3, sound.speed=sound.speed.water, 
                           nangle=180)
tilt.spec.cont <- tilt.spectrum(krill, -180, 180, freq=120e3, sound.speed=sound.speed.water,
                                nangle=180, method="continuous")
plot(tilt.spec$angle, tilt.spec$TS, ty='l')
lines(tilt.spec.cont$angle, tilt.spec.cont$TS, col='blue')
```
